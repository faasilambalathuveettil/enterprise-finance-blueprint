...
const pillars: Pillar[] = [
  ...
  },
  {
    ...
    closer:
      "Translated Saudi ZATCA Phase 2 requirements into ERP specifications, customer master standards, and testing procedures. Delivered production-ready workflows that enabled successful go-live across multiple entities.",
  },
  {
    icon: Zap,
    tint: "purple",
